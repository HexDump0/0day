...
# Still cut: the lines that would spill into the gap (49.27, 51.67) and the
# very first "Drink all the booze" (54.25) — the 0DAY reveal card owns the
# drop bar in silence; the vocal enters on the first "Hack all the things".
# The rest of the chorus is IN per user decision 2026-07-16 — booze, vodka
# and all, uncut call-and-response through to the outro.
ALLOWED = {
    ...
    56.86, 59.36, 64.15, 66.89, 69.52,  # Drink all the booze (x5, first cut)
